  ...
  return (
    <div className="w-full">
      <div className="m-6 pt-10">
        <h1 className="text-center font-bold text-4xl">Special to try</h1>
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-x-4">
          <div className="card mt-8">
            <img
              src={img}
              alt="img may not found"
              className="w-[400px] h-[300px] rounded-md"
            />
            <h1 className="text-center font-bold text-2xl mt-2">Lorem ipsum</h1>
            <p className="text-center">Amir samntha</p>
